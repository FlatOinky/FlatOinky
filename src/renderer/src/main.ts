...
import characterSelectionTemplate from './templates/pages/character_selection.html';
import clientTemplate from './templates/pages/client.html';
import bannerTemplate from './templates/components/banner.html';
import worldSelectorTemplate from './templates/components/world_selector.html';

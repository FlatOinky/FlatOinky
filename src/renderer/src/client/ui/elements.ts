...
export const icon = {
	...
	alien: setupIconElement('icon-[tabler--alien]'),
	...
	binoculars: setupIconElement('icon-[tabler--binoculars]'),
	bread: setupIconElement('icon-[tabler--bread]'),
	breadOff: setupIconElement('icon-[tabler--bread-off]'),
	bulb: setupIconElement('icon-[tabler--bulb]'),
	bulbOff: setupIconElement('icon-[tabler--bulb-off]'),
	...
	diamond: setupIconElement('icon-[tabler--diamond]'),
	...
	messageReport: setupIconElement('icon-[tabler--message-report]'),
	messages: setupIconElement('icon-[tabler--messages]'),
	messagesOff: setupIconElement('icon-[tabler--messages-off]'),
	meteor: setupIconElement('icon-[tabler--meteor]'),
	minus: setupIconElement('icon-[tabler--minus]'),
	moodSilence: setupIconElement('icon-[tabler--mood-silence]'),
	notification: setupIconElement('icon-[tabler--notification]'),
	notificationOff: setupIconElement('icon-[tabler--notification-off]'),
	paint: setupIconElement('icon-[tabler--paint]'),
	pencil: setupIconElement('icon-[tabler--pencil]'),
	pick: setupIconElement('icon-[tabler--pick]'),
	play: setupIconElement('icon-[tabler--play]'),
	playerPause: setupIconElement('icon-[tabler--player-pause]'),
	playerPlay: setupIconElement('icon-[tabler--player-play]'),
	playerStop: setupIconElement('icon-[tabler--player-stop]'),
	plus: setupIconElement('icon-[tabler--plus]'),
	puzzle: setupIconElement('icon-[tabler--puzzle]'),
	questionMark: setupIconElement('icon-[tabler--question-mark]'),
	refresh: setupIconElement('icon-[tabler--refresh]'),
	regex: setupIconElement('icon-[tabler--regex]'),
	regexOff: setupIconElement('icon-[tabler--regex-off]'),
	repeat: setupIconElement('icon-[tabler--repeat]'),
	repeatOff: setupIconElement('icon-[tabler--repeat-off]'),
	replaceUser: setupIconElement('icon-[tabler--replace-user]'),
	...
	tree: setupIconElement('icon-[tabler--tree]'),
